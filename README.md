...
<head>
  ...
  color:#fff;
  font-weight:800;
  font-size:36px; /* เพิ่มขนาดตัวอักษร FAQ */
    ...
    <div class="accordion" id="faq">
      ...
      <div class="item" data-id="9">
        ...
        <div class="answer" aria-hidden="true">
          ...
          <p><strong>อัตราดอกเบี้ย MRR</strong> เป็นอัตราดอกเบี้ยลอยตัว สามารถเปลี่ยนแปลงเพิ่มขึ้นหรือลดลงได้ ตามประกาศของธนาคาร สามารถดูข้อมูลเพิ่มเติมได้ที่ <a href="https://www.cimbthai.com/th/personal/help-support/rates-charges/loan-interest-rates.html" id="form-interest  " target="_blank">อัตราดอกเบี้ยเงินกู้</a></p>
        </div>
      </div>
      ...
      <div class="item" data-id="13">
        ...
        <div class="answer" aria-hidden="true">
          ...
          <ul>
            ...
            <p>ดูข้อมูลเพิ่มเติมได้ที่ <a href="https://drive.google.com/file/d/1RJMTRaPe6JVd3bonqcamz65nPhiH47I9/view?usp=sharing_blank" rel="noopener noreferrer">ขั้นตอนการเปิดบัญชีเงินฝากออมทรัพย์ ธนาคาร ซีไอเอ็มบี ไทย</a></p>
      ...
      <div class="item" data-id="14">
        <div class="question" tabindex="0" role="button" aria-expanded="false">
          <h3>ขั้นตอนการตั้งโอนล่วงหน้าผ่านแอป CIMB THAI ?</h3>
          <div class="chev" aria-hidden="true">›</div>
        </div>
        <div class="answer" aria-hidden="true">
          <p>วิธีการตั้งโอนล่วงหน้าผ่านแอป CIMB THAI เพื่อไม่ให้พลาดทุกการใช้จ่าย บิลค่าน้ำ/ค่าไฟ และสินเชื่อ เป็นต้น สามารถดำเนินการได้ตามขั้นตอน ดังนี้</p>
          <ul>
            <li>ขั้นตอนที่ 1 : เมื่อเข้าสู่แอป CIMB THAI กด "+" หรือ "เลื่อนขึ้นเพื่อดูบริการทั้งหมด"</li>
            <li>ขั้นตอนที่ 2 : เลือกเมนู "รายการล่วงหน้า"</li>
            <li>ขั้นตอนที่ 3 : กด "ตั้งรายการล่วงหน้า"</li>
            <li>ขั้นตอนที่ 4 : เลือกเมนู "จ่ายบิล" กดถัดไป</li>
            <li>ขั้นตอนที่ 5 : ระบบจะแสดงรายการบิลที่สามารถตั้งจ่ายบิลล่วงหน้าได้ กรุณาเลือกบิลที่ท่านต้องการชำระ</li>
            <li>ขั้นตอนที่ 6 : กรอกเลขที่บัญชีสินเชื่อและกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 7.1 : หากท่านต้องการจ่ายบิลล่วงหน้าแค่ครั้งเดียว โปรดตรวจสอบรายการบิลที่ท่านต้องการจ่าย พร้อมระบุจำนวนเงินให้เรียบร้อย และกดเลือกประเภทรายการล่วงหน้า "ครั้งเดียว" พร้อมระบุวันที่ท่านต้องการจ่ายบิลล่วงหน้า โดยท่านสามารถกำหนด "ชื่อรายการล่วงหน้า" และ "บันทึกช่วยจำ" ในกล่องข้อความด้านล่าง เพื่อทำรายการต่อกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 7.2 : หากท่านต้องการจ่ายบิลล่วงหน้าแบบรายเดือน โปรดตรวจสอบรายการบิลที่ท่านต้องการจ่าย พร้อมระบุจำนวนเงินให้เรียบร้อย และกดเลือกประเภทรายการล่วงหน้า "ทุกเดือน" พร้อมระบุวันที่เริ่มต้น และสิ้นสุดการทำรายการ กำหนดชื่อรายการล่วงหน้าและบันทึกช่วยจำ (ถ้ามี) เพื่อทำรายการต่อกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 8 : ตรวจสอบรายละเอียดรายการจ่ายบิลล่วงหน้าของท่านให้เรียบร้อย และกด "ยืนยัน"</li>
            <li>ขั้นตอนที่ 9 : ใส่รหัสผ่าน</li>
            <li>ขั้นตอนที่ 10 : หากรหัสผ่านถูกต้องระบบจะแสดงข้อความ "ตั้งรายการล่วงหน้าเรียบร้อยแล้ว"</li>
            <li>ขั้นตอนที่ 11 : ท่านสามารถตรวจสอบรายการล่วงหน้าที่ผ่านมาแล้วจากเมนู "ประวัติรายการ" และเลือกประเภทรายการแบบ "ครั้งเดียว" หรือ "ทุกเดือน"</li>
            <p>ดูข้อมูลเพิ่มเติมได้ที่ <a href="https://drive.google.com/file/d/1d83xhZEZtECEpaHEfxj9rNraaYYwqIVO/view?usp=sharing_blank" rel="noopener noreferrer">ขั้นตอนการเปิดบัญชีเงินฝากออมทรัพย์ ธนาคาร ซีไอเอ็มบี ไทย</a></p>
            <p>โปรดติดต่อสาขาของธนาคาร ซีไอเอ็มบี ไทย เพื่อทำการเปิดบัญชีเงินฝากออมทรัพย์แทน หากท่านไม่สามารถเปิดบัญชีเงินฝากออมทรัพย์ผ่านแอป CIMB THAI ได้</p>
          </ul>
        </div>
      </div>      
      ...
      <div class="item" data-id="15">
        ...
        <div class="answer" aria-hidden="true">
          ...
          <ul>
            ...
            <li>ขั้นตอนที่ 3 : กดเลือกเมนู “สินเชื่อบ้าน โฮมโลนฟอร์ยู” ในหน้ารายการสินเชื่อ</li>
            <li>ขั้นตอนที่ 4 : กดเลือกเมนูอื่นๆ ตรงมุมขวาของหน้าสินเชื่อบ้าน โฮมโลนฟอร์ยู</li>
            <li>ขั้นตอนที่ 5 : กดเลือกเมนู “ขอหนังสือรับรองดอกเบี้ยบ้าน”</li>
            <li>ขั้นตอนที่ 6 : ตรวจสอบอีเมลสำหรับ รับหนังสือรับรองดอกเบี้ยบ้าน</li>
      ...
      <div class="item" data-id="17">
        <div class="question" tabindex="0" role="button" aria-expanded="false">
          <h3>สามารถตั้งจ่ายบิลล่วงหน้าผ่านแอป CIMB THAI ได้หรือไม่ ?</h3>
          <div class="chev" aria-hidden="true">›</div>
        </div>
        <div class="answer" aria-hidden="true">
          <p>วิธีการตั้งจ่ายบิลล่วงหน้าผ่านแอป CIMB THAI</p>
          <ul>
            <li>ขั้นตอนที่ 1 : เมื่อเข้าสู่แอป CIMB THAI กด "+" หรือ "เลื่อนขึ้นเพื่อดูบริการทั้งหมด"</li>
            <li>ขั้นตอนที่ 2 : เลือกเมนู "รายการล่วงหน้า"</li>
            <li>ขั้นตอนที่ 3 : กด "ตั้งรายกาาล่วงหนเ้า"</li>
            <li>ขั้นตอนที่ 4 : เลือกเมนู "จ่ายบืล" กดถัดไป</li>
            <li>ขั้นตอนที่ 5 : ระบบจะแสดงรายการบิลที่สามารถตั้งจ่ายบิลล่วงหน้าได้ กรุณาเลือกบิลที่ท่านต้องการชำระ</li>
            <li>ขั้นตอนที่ 6 : กรอกเลขที่บัญชีสินเชื่อและกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 7.1 : หากท่านต้องการจ่ายบิลล่วงหน้าแค่ครั้งเดียว โปรดตรวจสอบรายการบิลที่ท่านต้องการจ่าย พร้อมระบุจำนวนเงินให้เรียบร้อย และกดเลือกประเภทรายการล่วงหน้า "ครั้งเดียว" พร้อมระบุวันที่ท่านต้องการจ่ายบิลล่วงหน้า โดยท่านสามารถกำหนด "ชื่อรายการล่วงหน้า" และ "บันทึกช่วยจำ" ในกล่องข้อความข้อความด้านล่าง เพื่อทำรายการต่อกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 7.1 : หากท่านต้องการจ่ายบิลล่วงหน้าแค่ครั้งเดียว โปรดตรวจสอบรายการบิลที่ท่านต้องการจ่าย พร้อมระบุจำนวนเงินให้เรียบร้อย และกดเลือกประเภทรายการล่วงหน้า "ทุกเดือน" พร้อมระบุวันที่เริ่มต้น และสิ้นสุดการทำรายการ กำหนด "ชื่อรายการล่วงหน้า" และ "บันทึกช่วยจำ" (ถ้ามี) เพื่อทำรายการต่อกด "ถัดไป"</li>
            <li>ขั้นตอนที่ 8 : ตรวจสอบรายละเอียดรายการจ่ายบิลล่วงหน้าของท่านให้เรียบร้อย และกด "ยืนยัน"</li>
            <li>ขั้นตอนที่ 9 : ใส่รหัสผ่าน</li>
            <li>ขั้นตอนที่ 10 : หากรหัสผ่านถูกต้องระบบจะแสดงข้อความ "ตั้งรายการล่วงหน้าเรียบร้อยแล้ว"</li>
            <li>ขั้นตอนที่ 11 : ท่านสามารถตรวจสอบรายการล่วงหน้าที่ผ่านมาจากประวัติรายการท่านได้ตั้งไว้ โดยเลือกเมนู "รายการล่วงหน้า" แล้วเลือกประเภทรายการแบบ "ครั้งเดียว" หรือ "ทุกเดือน"</li>
            <li>ขั้นตอนที่ 12 : ท่านสามารถตรวจสอบรายการล่วงหน้าที่ผ่านมาแล้วจากเมนู "ประวัติรายการ" แล้วเลือกประเภทรายการแบบ "ครั้งเดียว" หรือ "ทุกเดือน"</li>
            <p>ดูข้อมูลเพิ่มเติมได้ที่ <a href="https://www.cimbthai.com/th/personal/ways-to-bank/cimb-thai-digital-banking/step-e-statement.html" rel="noopener noreferrer">ขั้นตอนสมัครรับบริการ e-Statement สำหรับลูกค้าสินเชื่อ</a></p>
            <p>ท่านสามารถร้องขอสำเนาเอกสารใบแจ้งยอด/ใบเสร็จรับเงินผ่านช่องทาง CIMB Care Center ที่หมายเลข 02-626-7777</p>
          </ul>
        </div>
      ...
      <div class="item" data-id="19">
        ...
        <div class="answer" aria-hidden="true">
          <ul>
            ...
            <li><a href="https://drive.google.com/file/d/1OlgplTDN4sj0Lr_hrpE9NCvN_vREQflx/view?usp=sharing_blank" id="Sales Sheet MP" target="_blank" rel="noopener noreferrer">Sales sheet Mortgagepower ตารางการเปิดเผยข้อมูลผลิตภัณฑ์สินเชื่ออเนกประสงค์ (มอร์เกจพาวเวอร์)</a></li>
            <li><a href="https://www.cimbthai.com/content/dam/cimbth/personal/documents/loan/Poperty-loan/2026/Sales%20sheet%20PY_Eff%20180868_080868.pdf" id="Sales Sheet PL" target="_blank" rel="noopener noreferrer">Sales sheet Property Loan ตารางการเปิดเผยข้อมูลผลิตภัณฑ์สินเชื่ออเนกประสงค์ (พร็อพเพอร์ตี้โลน)</a></li>
          </ul>
        </div>
      </div>
